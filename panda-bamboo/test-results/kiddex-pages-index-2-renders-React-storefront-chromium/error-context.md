...
- Name: kiddex-pages.spec.ts >> index-2 renders React storefront
...
- main:
  - paragraph: Home 2
  - heading "Playtime Starts Here — Toys Kids Love" [level=1]
  - paragraph: From $38.99
  - link "View Shop":
    - /url: /shop
  - heading "Shop by Category" [level=2]
  - link "Kids Toys":
    - /url: /shop
    - heading "Kids Toys" [level=4]
  - link "Indoor Games":
    - /url: /shop
    - heading "Indoor Games" [level=4]
  - link "Puzzle Games":
    - /url: /shop
    - heading "Puzzle Games" [level=4]
  - link "Kids Books":
    - /url: /shop
    - heading "Kids Books" [level=4]
  - link "Balloons Cards":
    - /url: /shop
    - heading "Balloons Cards" [level=4]
  - link "Water Toys":
    - /url: /shop
    - heading "Water Toys" [level=4]
  - paragraph: Featured
  - heading "Baby Toy's" [level=3]
  - paragraph: From $00.99
  - link "Shop now":
    - /url: /shop
  - paragraph: Hot Sale
  - heading "Gaming" [level=3]
  - paragraph: From $10.99
  - link "Shop now":
    - /url: /shop
  - paragraph: Latest Deals
  - heading "Accessories" [level=3]
  - paragraph: From $20.99
  - link "Shop now":
    - /url: /shop
  - heading "Today's popular picks" [level=2]
  - article:
    - text: 6% Off
