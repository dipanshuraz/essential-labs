...
- Name: kiddex-pages.spec.ts >> blog-details renders React storefront
  ...
  - list:
    - listitem:
      - link "Home":
        - /url: /
    - listitem: Blog
  - heading "Latest From Media" [level=2]
  - article:
    - paragraph: By Jeams
    - 'heading "Dressing Your Little One: Stylish and Comfortable Baby Outfits" [level=3]':
      - 'link "Dressing Your Little One: Stylish and Comfortable Baby Outfits"':
        - /url: /blog-details
  - article:
    - paragraph: By Jeams
    - 'heading "Baby Gear Essentials: What You Really Need" [level=3]':
      - 'link "Baby Gear Essentials: What You Really Need"':
        - /url: /blog-details
  - article:
    - paragraph: By Jeams
    - 'heading "Babyproofing Your Home: A Comprehensive Guide" [level=3]':
      - 'link "Babyproofing Your Home: A Comprehensive Guide"':
        - /url: /blog-details
  - article:
    - paragraph: By Jeams
    - heading "How to Choose the Perfect Crib for Your Baby" [level=3]:
      - link "How to Choose the Perfect Crib for Your Baby":
        - /url: /blog-details
