...
- Name: kiddex-pages.spec.ts >> account renders React storefront
...
Call log:
  ...
  - waiting for locator('text=Kiddex').first()
    14 × locator resolved to <title>Account · Kiddex</title>
...
- main:
  ...
  - paragraph: Manage your profile and orders
  - textbox: hello@example.com
  - textbox: Demo Customer
  - button "Save changes"
