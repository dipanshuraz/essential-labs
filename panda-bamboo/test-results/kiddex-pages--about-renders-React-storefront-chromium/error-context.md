...
- Name: kiddex-pages.spec.ts >> /about renders React storefront
  ...
  - list:
    - listitem:
      - link "Home":
        - /url: /
    - listitem: About us
  - heading "We are a retail business in the Ecommerce Products and accessories for kids" [level=1]
  - paragraph: Balloon, with a rich legacy spanning 12 years, stands as a venerable online destination for parents seeking high-quality toys and accessories.
  - paragraph: All components featured in our inventory undergo rigorous quality checks to meet or exceed industry standards.
  - paragraph: 25+
  - paragraph: Retails Store in the city
  - paragraph: 300+
  - paragraph: Active Delivery Person
  - paragraph: 120+
  - paragraph: Brands and Companies
  - list:
    - listitem: Toy Car
    - listitem: Girls Doll
    - listitem: Balloons
    - listitem: Color Plate
    - listitem: Puzzles
    - listitem: Cubes
    - listitem: Toy Car
    - listitem: Girls Doll
